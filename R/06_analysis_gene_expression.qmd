...
```{r}
plot_status <- PCA_er_status + PCA_her2_status / PCA_pr_status
plot_status

plot_therapy <- PCA_Chemotherapy + PCA_Hormonetherapy / PCA_Radiotherapy
plot_therapy
