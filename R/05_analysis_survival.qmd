...
A survival rate of 0.44 means that, on average 44% of the individuals in the data set have survived the breast cancer.
...
age_boxplot <- ggplot(data = clinical_data,
    mapping = aes(x = overall_survival, y = age_at_diagnosis, fill = factor(overall_survival))) +
...
tumor_histogram <- ggplot(clinical_data, aes(x = tumor_size, y = ..density..)) +
...
mutation_histogram <- ggplot(clinical_data, aes(x = mutation_count, y = ..density..)) +
  geom_histogram(fill = "blue", color = "white", alpha = 0.7) +
...
mutation_plot1 <- mutation_histogram + geom_line(
  data = mutation_curve, 
  aes(x = x, y = y), color = "red")
...
tumor_histogram_log <- ggplot(clinical_data, aes(x = tumor_size_log, y = ..density..)) +
...
tumor_plot2 <- tumor_histogram_log + geom_line(
  data = tumor_curve_log, 
  aes(x = x, y = y), color = "red")
...
mutation_histogram_log <- ggplot(clinical_data, aes(x = mutation_count_log, y = ..density..)) +
  geom_histogram(fill = "blue", color = "white", alpha = 0.9) +
...
mutation_plot2 <- mutation_histogram_log + geom_line(
  data = mutation_curve_log, 
  aes(x = x, y = y), color = "red")
...
lymph_boxplot <- ggplot(data = clinical_data, aes(y = as.factor(lymph_nodes_examined_positive), x = tumor_size_log, color = lymph_nodes_examined_positive)) +   
  geom_boxplot(alpha = 0.5, 
               show.legend = FALSE) +
...
```{r}
ggsave("06_age_boxplot.png", 
       path = "../doc/images/",
       plot = age_boxplot,
       width = 8,
       height = 5)

ggsave("06_age_bar.png", 
       path = "../doc/images/",
       plot = age_bar,
       width = 8,
       height = 5)

ggsave("06_age_tumor_survival_boxplot.png", 
       path = "../doc/images/",
       plot = age_tumor_survival_boxplot,
       width = 8,
       height = 5)

ggsave("06_tumor_plot1.png", 
       path = "../doc/images/",
       plot = tumor_plot1,
       width = 8,
       height = 5)

ggsave("06_tumor_plot2.png", 
       path = "../doc/images/",
       plot = tumor_plot2,
       width = 8,
       height = 5)

ggsave("06_surv_treatment.png", 
       path = "../doc/images/",
